...
plot_histogram(rounded_df, dim1=5, dim2=5)
...
bin_idx = [tuple(row) for row in binned_df.values]
...
sample_size = 100
sampled_indices = np.random.choice(len(X_df), size=sample_size, replace=False, p=probabilities)
X_sampled = X_df.iloc[sampled_indices]
